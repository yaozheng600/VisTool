...
if language =='🇬🇧':
    ...
    with st.container():
        ...
        为了帮助我们提高工具的可用性，我们设置了三个测试迭代。在 __Exploration__ 中，我们应用
         各种组件来测试哪一个对找到最佳权衡具有积极影响。在 __Improvement__ 中，我们专注于用户交互并让用户测试高保真原型。在 __Validation,__ 中，我们验证第二次迭代中的UI问题是否已解决。
        """
